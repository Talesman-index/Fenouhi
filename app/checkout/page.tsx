    ...
    return (
      <div style={{ background: "#FAF7F2", minHeight: "85vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center", color: "#64748B", fontSize: 14, fontWeight: 700 }}>
          Vérification de la session sécurisée CargoLink...
        </div>
      </div>
    );
  }
        ...
        <div className="container" style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          >
            ...
            >
              ...
              <span>Espace Client Sécurisé CargoLink</span>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              >
                ...
                <span>Créer un compte client CargoLink</span>
              </Link>
            </div>
          </div>
        </div>
      ...
      <div className="container" style={{ maxWidth: 1240, margin: "0 auto", padding: "0 20px" }}>
        ...
        >
          ...
          >
            ...
            <span>Compte vérifié CargoLink</span>
          </div>
        </div>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, flexWrap: "wrap", gap: 8 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <span style={{ fontSize: 12, fontWeight: 800, letterSpacing: "0.08em", textTransform: "uppercase", color: "#38BDF8" }}>
                Processus Logistique CargoLink
              </span>
            </div>
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: 13.5, fontWeight: 600, color: "#0F172A" }}>
                  J'ai lu les conditions générales de vente CargoLink et j'y adhère sans réserve.
                </span>
              </div>
          ...
          >
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 6, color: "#0F172A", fontWeight: 800 }}>
                ...
                <span>Garantie CargoLink 100% Sécurisé</span>
              </div>
              <div>
