...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    oldPrice: 18000,
    minQty: 1,
    image: "/images/assets/facial_steamer_1.png",
    images: ["/images/assets/facial_steamer_1.png"],
    category: "beauty",
  ...
  },
  {
    ...
    oldPrice: 19500,
    minQty: 1,
    image: "/images/assets/snail_collagen_set_1.png",
    images: ["/images/assets/snail_collagen_set_1.png"],
    category: "beauty",
  ...
  },
  {
    ...
    oldPrice: 16500,
    minQty: 1,
    image: "/images/assets/dr_rashel_24k_gold_1.png",
    images: ["/images/assets/dr_rashel_24k_gold_1.png"],
    category: "beauty",
  ...
  },
  {
    ...
    oldPrice: 16000,
    minQty: 1,
    image: "/images/assets/dr_rashel_vitamin_c_1.jpg",
    images: ["/images/assets/dr_rashel_vitamin_c_1.jpg"],
    category: "beauty",
  ...
  },
  {
    ...
    oldPrice: 3000,
    minQty: 1,
    image: "/images/assets/aichun_stretch_marks_1.png",
    images: ["/images/assets/aichun_stretch_marks_1.png"],
    category: "beauty",
  ...
  {
    id: "masque-yeux-collagene-dore",
    title: "Masque Patch Yeux Hydrogel au Collagène Doré & Antioxydants",
    subtitle: "Anti-cernes, anti-poches, réduction des rides & hydratation intense du regard",
    price: 1500,
    oldPrice: 2800,
    minQty: 1,
    image: "/images/assets/gold_collagen_eyemask_1.png",
    images: ["/images/assets/gold_collagen_eyemask_1.png"],
    category: "beauty",
    badge: "SOIN REGARD • COLLAGÈNE",
    origin: "Chine (FenouShop Partner)",
    weight: "0.05 kg",
    volume: "0.0001 CBM",
    rating: 4.9,
    ...
    grade: "Grade A",
    description:
      "Le masque patch pour les yeux au collagène doré regorge d'antioxydants puissants et d'extraits hautement hydratants pour revitaliser et illuminer le contour des yeux. La perte naturelle de collagène étant directement liée au vieillissement cutané, ce soin apporte force, élasticité et tonicité à la peau pour réduire visiblement les rides et ridules. En plus de combattre le vieillissement, ce masque apaise et réhydrate intensément les peaux déshydratées, adoucit et fortifie la zone fragile du contour de l'œil, élimine les poches matinales, estompe les cernes et apporte un concentré de vitamines essentielles pour un regard instantanément reposé et radieux.",
    features: [
      "Patchs hydrogel enrichis en collagène actif doré et puissants antioxydants",
      "Effet rafraîchissant immédiat : décongestionne les poches et illumine le contour des yeux",
      "Réduit visiblement les cernes foncés et les ridules de fatigue ou de déshydratation",
      "Restaure l'élasticité naturelle, adoucit et fortifie la peau fragile du regard",
      "Apporte un cocktail de vitamines régénérantes et une hydratation intense",
      "Application facile 15 à 20 minutes (matin coup d'éclat ou soir après démaquillage)",
    ],
    specifications: [
      { label: "Type de produit", value: "Masque Patchs Hydrogel Yeux" },
      { label: "Actifs clés", value: "Collagène doré, Acide Hyaluronique, Vitamines & Antioxydants" },
      { label: "Bénéfices majeurs", value: "Anti-cernes, Décongestion des poches, Lissage des rides" },
      { label: "Temps de pose", value: "15 à 20 minutes" },
      { label: "Type de peau", value: "Tous types de peaux (Idéal regards fatigués et déshydratés)" },
      { label: "État / Condition", value: "Neuf Scellé Sachet individuel stérile" },
    ],
    reviews: [
      { author: "Grâce T.", rating: 5, comment: "Ce patch doré est magique pour les matins difficiles ! Les yeux dégonflent direct et le regard est super lumineux.", date: "23 Fév. 2025" },
      { author: "Rolande V.", rating: 5, comment: "Très frais, tient bien sous les yeux sans glisser. Mes cernes sont beaucoup moins marqués.", date: "23 Fév. 2025" },
    ],
    related: ["masque-levres-rose-hydrogel", "dr-rashel-24k-gold-5pieces", "disaar-masque-vitamine-c"],
  },
  {
    ...
    oldPrice: 2800,
    minQty: 1,
    image: "/images/assets/roushun_aloe_vera_scrub_1.png",
    images: ["/images/assets/roushun_aloe_vera_scrub_1.png"],
    category: "beauty",
    ...
    related: ["disaar-masque-vitamine-c", "dr-rashel-vitamin-c-set", "masque-yeux-collagene-dore"],
  },
  {
    ...
    oldPrice: 2800,
    minQty: 1,
    image: "/images/assets/aichun_collagen_milk_mask_1.png",
    images: ["/images/assets/aichun_collagen_milk_mask_1.png"],
    category: "beauty",
  ...
  },
  {
    ...
    oldPrice: 2000,
    minQty: 1,
    image: "/images/assets/papaya_soap_1.png",
    images: ["/images/assets/papaya_soap_1.png"],
    category: "beauty",
