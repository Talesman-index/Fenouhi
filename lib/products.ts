...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    specifications: [
      ...
      { label: "Minimum commande", value: "20 unités" },
    ],
    reviews: [
  ...
  },
  {
    ...
    specifications: [
      ...
      { label: "Minimum commande", value: "20 paires" },
    ],
    reviews: [],
    related: ["6", "8", "10"],
  },
  {
    ...
    specifications: [
      ...
      { label: "Minimum commande", value: "50 unités" },
    ],
    reviews: [],
    related: [],
  },
  {
    ...
    specifications: [
      ...
      { label: "Minimum commande", value: "50 pièces" },
    ],
    reviews: [],
    related: ["4", "8"],
  },
  {
    ...
    specifications: [
      ...
      { label: "Minimum commande", value: "20 coffrets" },
    ],
    reviews: [],
    related: ["1", "4"],
  },
  {
    ...
    specifications: [
      ...
      { label: "Minimum commande", value: "20 pièces" },
    ],
    reviews: [],
    related: ["4", "6"],
  },
  {
    ...
    specifications: [
      ...
      { label: "Minimum commande", value: "100 paires" },
    ],
    reviews: [],
    related: [],
  },
