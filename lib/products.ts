...
export const PRODUCTS: Product[] = [
  {
    ...
    reviewsCount: 248,
    description:
      "La SmartFit Pro X GPS est une montre connectée de niveau premium, produite directement en usine certifiée et disponible en lot grossiste à prix usine via CargoLink Africa. Écran AMOLED HD 1.85\", suivi cardiaque en temps réel, SpO2, GPS intégré, étanchéité IP68 et autonomie de 7 jours. Compatible iOS & Android. Emballage individuel renforcé inclus.",
    features: [
